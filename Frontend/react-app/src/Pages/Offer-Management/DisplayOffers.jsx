...
const DisplayOffers = () => {
  ...
  return (
    <>
    <div className="offers">MANAGE Offers</div>
        ...
        <tbody>
          {offers.map((offer) => (
            <tr key={offer._id}>
              ...
              <td>
                <button type="button" onClick={() => HandleEdit(offer._id)}>Edit</button>
                <button type="button" onClick={() => handleDelete(offer._id)}>Delete</button>
              </td>
            </tr>
          ))}
        </tbody>
